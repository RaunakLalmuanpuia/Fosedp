<template>
    <div class="flex justify-between items-center text-color">
        <div>
            <p class="page-header">Upload Form 7</p>
            ...
            <q-breadcrumbs>
                ...
                <q-breadcrumbs-el :href="route('form-upload-seven.index')"
                                  label="Form 7"/>
                <q-breadcrumbs-el label="Upload Form 7 - Inspection Report"/>
            </q-breadcrumbs>
        </div>
    </div>
    <br/>
...
const submit=e=>{
    form.transform(data=>({department_id:data.department.value,...data}))
        .post(route('form-upload.store','form-seven'),{
