<template>
            <div class="flex justify-between items-center">
                <div>
                    <p class="page-header">List of District</p>
                    <q-breadcrumbs >
                        <q-breadcrumbs-el :href="route('dashboard')" label="Dashboard" icon="o_dashboard"/>
                        <q-breadcrumbs-el label="District"/>
                    </q-breadcrumbs>
                </div>
                <q-btn color="accent" label="New District"  @click="$inertia.get(route('district.create'))"/>
            </div>
            <br/>
                <q-table
                    ...
                    <template #body-cell-action="props">
                        <td align="right">
                            <div class="flex q-gutter-sm justify-end">
                                <q-btn @click="$inertia.get(route('district.edit',props.row.id))" size="sm" icon="edit" outline/>
