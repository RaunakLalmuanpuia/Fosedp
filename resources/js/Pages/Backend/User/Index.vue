<template>
    <div class="flex justify-between items-center">
        <div>
            <p class="page-header">List of users</p>
            <q-breadcrumbs>
                <q-breadcrumbs-el icon="o_dashboard" label="Dashboard" @click="$inertia.get(route('dashboard'))"/>
                <q-breadcrumbs-el class="text-color" label="Users"/>
            </q-breadcrumbs>
        </div>
        <q-btn color="accent" label="New User" rounded @click="$inertia.get(route('user.create'),{},{
                    preserveState:false
                })"/>
    </div>
    <br/>
    ...
    <q-table
        ...
        <template #body-cell-departments="props">
            <td align="left">
                <q-chip v-for="role in props.row.departments"
                        :label="role?.name" square/>
            </td>
        </template>
        <template #body-cell-action="props">
            <td align="right">
                <div class="flex q-gutter-sm justify-end">
                    <q-btn icon="edit" outline size="sm" @click="$inertia.get(route('user.edit',props.row.id))"/>
...
const columns = [
    ...
    {name: 'departments', align: 'left', label: 'Departments', field: 'departments',},
