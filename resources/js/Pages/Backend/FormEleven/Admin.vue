<template>
    <div class="flex justify-between items-center text-color">
        <div>
            ...
            <p class="text-caption">Form-11 (Monitory Report) Submitted by all departments</p>
            <q-breadcrumbs>
                <q-breadcrumbs-el :href="route('dashboard')" icon="o_dashboard" label="Dashboard"/>
                <q-breadcrumbs-el :href="route('form-upload-eleven.all')"
                                  label="Form 11 - Monitory Format"/>
            </q-breadcrumbs>
        </div>
...
const doFilter=value=>{
    router.get(route('form-eleven.all'),{
