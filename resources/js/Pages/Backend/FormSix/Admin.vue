<template>
    <div class="flex justify-between items-center text-color">
        <div>
            <p class="page-header">Form-6</p>
            <p class="text-caption">Form-6 (Utilization Certificate) Submitted by all departments</p>
            <q-breadcrumbs>
                <q-breadcrumbs-el :href="route('dashboard')" icon="o_dashboard" label="Dashboard"/>
                <q-breadcrumbs-el :href="route('form-upload-six.all')"
                                  label="Form 6 - (Utilization Certificate)"/>
            </q-breadcrumbs>
        </div>
